var CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=8e3e2d&fwbuild=dev"};
...
document.write('<script>goog.require("minesweeper_reagent.core");</script>');

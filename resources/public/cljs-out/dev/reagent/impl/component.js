...
if((i < len)){
var k = (ks[i]);
var G__12926 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__12927 = (i + (1));
m = G__12926;
i = G__12927;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__12928 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__12928) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__12928));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__12930 = c;
var G__12930__$1 = (((G__12930 == null))?null:G__12930.prototype);
if((G__12930__$1 == null)){
return null;
} else {
return (G__12930__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__12932 = c;
var G__12932__$1 = (((G__12932 == null))?null:G__12932.prototype);
if((G__12932__$1 == null)){
return null;
} else {
return (G__12932__$1["render"]);
}
})() == null))));
});
...
return (function() { 
var G__12936__delegate = function (args){
var G__12934 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__12934) : reagent.impl.component.as_element.call(null,G__12934));
};
...
while (G__12937__i < G__12937__a.length) {G__12937__a[G__12937__i] = arguments[G__12937__i + 0]; ++G__12937__i;}
  args = new cljs.core.IndexedSeq(G__12937__a,0,null);
} 
...
var _STAR_current_component_STAR_12940 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_12940;
}});
...
return ((function (G__12941,G__12941__$1){
...
var c = this;
var G__12946_12948 = (c["cljsRatom"]);
if((G__12946_12948 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12946_12948);
}
...
var renders_12950 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_12951 = cljs.core.first(cljs.core.vals(renders_12950));
if((cljs.core.count(renders_12950) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_12950))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_12951)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_12951], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__12949 = name;
switch (G__12949) {
case "":
...
var G__12954 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__12954) : reagent.impl.component.global$module$create_react_class.call(null,G__12954));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__12955 = fiber;
var G__12955__$1 = (((G__12955 == null))?null:(G__12955["type"]));
if((G__12955__$1 == null)){
return null;
} else {
return (G__12955__$1["displayName"]);
}
})();
var parent = (function (){var G__12956 = fiber;
if((G__12956 == null)){
return null;
} else {
return (G__12956["return"]);
}
})();
var path = (function (){var G__12957 = parent;
var G__12957__$1 = (((G__12957 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__12957) : reagent.impl.component.fiber_component_path.call(null,G__12957)));
if((G__12957__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12957__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__12959 = c;
if((G__12959 == null)){
return null;
} else {
return (G__12959["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__12960._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__12962 = c;
if((G__12962 == null)){
return null;
} else {
return (G__12962["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__12964 = c;
if((G__12964 == null)){
return null;
} else {
return G__12964._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__12966 = instance;
if((G__12966 == null)){
return null;
} else {
return (G__12966["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__12967 = instance;
if((G__12967 == null)){
return null;
} else {
return G__12967._currentElement;
}
}
})();
var name = (function (){var G__12968 = elem;
var G__12968__$1 = (((G__12968 == null))?null:(G__12968["type"]));
if((G__12968__$1 == null)){
return null;
} else {
return (G__12968__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__12970 = elem;
if((G__12970 == null)){
return null;
} else {
return (G__12970["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__12971._owner;
}
}
})();
var path = (function (){var G__12972 = owner;
var G__12972__$1 = (((G__12972 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__12972) : reagent.impl.component.component_path.call(null,G__12972)));
if((G__12972__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12972__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__12973 = c;
var G__12973__$1 = (((G__12973 == null))?null:G__12973.constructor);
if((G__12973__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__12973__$1);
}
}
})();

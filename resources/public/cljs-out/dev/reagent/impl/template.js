...
var G__10134 = o;
(G__10134[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__10136__i < G__10136__a.length) {G__10136__a[G__10136__i] = arguments[G__10136__i + 0]; ++G__10136__i;}
  args = new cljs.core.IndexedSeq(G__10136__a,0,null);
} 
...
var G__10138 = o;
(G__10138[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__10140__i < G__10140__a.length) {G__10140__a[G__10140__i] = arguments[G__10140__i + 0]; ++G__10140__i;}
  args = new cljs.core.IndexedSeq(G__10140__a,0,null);
} 
...
var G__10143 = props;
var G__10143__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__10143,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10143);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__10143__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__10144){
...
var props = map__10145__$1;
var class$ = cljs.core.get.call(null,map__10145__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__10145,map__10145__$1,props,class$){
return (function (c){
...
});})(map__10145,map__10145__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10147){
...
var on_write = cljs.core.get.call(null,map__10148__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__10148,map__10148__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__10148,map__10148__$1,on_write))
);
} else {
...
var G__10151 = jsprops;
(G__10151["defaultValue"] = value);

(G__10151["onChange"] = ((function (G__10151,v,value,on_change){
return (function (p1__10150_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10150_SHARP_);
});})(G__10151,v,value,on_change))
);
...
var vec__10154 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10154,(0),null);
var id = cljs.core.nth.call(null,vec__10154,(1),null);
var class$ = cljs.core.nth.call(null,vec__10154,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___10158 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___10158 == null)){
} else {
var key_10159 = temp__5461__auto___10158;
...
var temp__5461__auto___10160 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___10160 == null)){
} else {
var key_10161 = temp__5461__auto___10160;
reagent.impl.template.oset.call(null,jsprops,"key",key_10161);
}
...
var G__10162 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__10162["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10165){
var G__10166 = cljs.core.first.call(null,seq10165);
var seq10165__$1 = cljs.core.next.call(null,seq10165);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10166,seq10165__$1);
});
...
break;
default:
var G__10172 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__10172;
continue;
...
var n__4408__auto___10174 = a.length;
var i_10175 = (0);
while(true){
if((i_10175 < n__4408__auto___10174)){
(a[i_10175] = reagent.impl.template.as_element.call(null,(a[i_10175])));
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___10177 = a.length;
var i_10178 = (0);
while(true){
if((i_10178 < n__4408__auto___10177)){
var val_10179 = (a[i_10178]);
if(((cljs.core.vector_QMARK_.call(null,val_10179)) && ((reagent.impl.template.key_from_vec.call(null,val_10179) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10178] = reagent.impl.template.as_element.call(null,val_10179));

var G__10180 = (i_10178 + (1));
i_10178 = G__10180;
continue;
} else {
}
...
var ctx = ({});
var vec__10181 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__10181,(0),null);
var derefed = cljs.core.nth.call(null,vec__10181,(1),null);
...
var G__10184 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10184) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__10184){

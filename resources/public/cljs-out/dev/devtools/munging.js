...
var o12230 = temp__5455__auto__;
var temp__5455__auto____$1 = (o12230["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o12231 = temp__5455__auto____$1;
return (o12231["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12050__auto__ = f;
return (o__12050__auto__["toString"]).call(o__12050__auto__);
} else {
return "";
}
}catch (e12232){var _ = e12232;
return "";
}});
...
try{var o__12050__auto___12234 = t;
(o__12050__auto___12234["cljs$lang$ctorPrWriter"]).call(o__12050__auto___12234,t,writer);
}catch (e12233){var __12235 = e12233;
}
...
var char_code = (function (){var o__12050__auto__ = (new String(char$));
return (o__12050__auto__["charCodeAt"]).call(o__12050__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12050__auto__ = String;
return (o__12050__auto__["fromCharCode"]).call(o__12050__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12236 = num_code;
switch (G__12236) {
case (1):
return (185);
...
var o__12050__auto__ = String;
return (o__12050__auto__["fromCharCode"]).call(o__12050__auto__,superscript_code);
});
/**
...
}catch (e12238){var _e__12057__auto__ = e12238;
return false;
}})())){
...
var vec__12239 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__12239,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o12242 = temp__5455__auto__;
var temp__5455__auto____$1 = (o12242["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o12243 = temp__5455__auto____$1;
return (o12243["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___12250 = arguments.length;
var i__4532__auto___12251 = (0);
while(true){
if((i__4532__auto___12251 < len__4531__auto___12250)){
args__4534__auto__.push((arguments[i__4532__auto___12251]));

var G__12252 = (i__4532__auto___12251 + (1));
i__4532__auto___12251 = G__12252;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12246){
var vec__12247 = p__12246;
var ns_detector = cljs.core.nth.call(null,vec__12247,(0),null);
...
var G__12253 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__12254 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__12253;
remaining_tokens = G__12254;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12244){
var G__12245 = cljs.core.first.call(null,seq12244);
var seq12244__$1 = cljs.core.next.call(null,seq12244);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12245,seq12244__$1);
});
...
var vec__12258 = cljs.core.split_with.call(null,(function (p1__12257_SHARP_){
return cljs.core.not_EQ_.call(null,p1__12257_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__12258,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__12258,(1),null);
...
var vec__12261 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__12261,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__12261,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__12264 = cljs.core.rest.call(null,remaining_tokens);
var G__12265 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__12264;
name_tokens = G__12265;
continue;
} else {
...
var vec__12268 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__12268,(0),null);
var arity = cljs.core.nth.call(null,vec__12268,(1),null);
var vec__12271 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__12271,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__12271,(1),null);
var vec__12274 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__12274,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__12274,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__12274,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__12274,(3),null);
...
var vec__12280 = result;
var munged_ns = cljs.core.nth.call(null,vec__12280,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__12280,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__12280,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__12280,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__12280,(4),null);
var arity = cljs.core.nth.call(null,vec__12280,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__12284 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__12284,(0),null);
var args = cljs.core.nth.call(null,vec__12284,(1),null);
var vec__12287 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__12287,(0),null);
var name = cljs.core.nth.call(null,vec__12287,(1),null);
...
var G__12290 = (arity + (1));
var G__12291 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12292){
var vec__12293 = p__12292;
var arity = cljs.core.nth.call(null,vec__12293,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__12293,(1),null);
...
return cljs.core.get.call(null,arities,p1__12296_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__12297_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12300){
var vec__12301 = p__12300;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__12301,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12298){
var G__12299 = cljs.core.first.call(null,seq12298);
var seq12298__$1 = cljs.core.next.call(null,seq12298);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12299,seq12298__$1);
});
...
var G__12307 = arg;
var G__12307__$1 = (((G__12307 instanceof cljs.core.Keyword))?G__12307.fqn:null);
switch (G__12307__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__12309__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__12309__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__12309__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__12309__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12310 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__12310,(0),null);
var fn_name = cljs.core.nth.call(null,vec__12310,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__12310,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__12310,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__12310,(4),null);
var arity = cljs.core.nth.call(null,vec__12310,(5),null);
...
var o__12050__auto__ = f;
return (o__12050__auto__["getBasis"]).call(o__12050__auto__);
});
/**
...
}catch (e12314){var _e__12057__auto__ = e12314;
...
var G__12315 = (obj[cljs.core.first.call(null,path)]);
var G__12316 = cljs.core.rest.call(null,path);
obj = G__12315;
path = G__12316;
continue;
} else {
...
return (function (accum,p__12317){
var vec__12318 = p__12317;
var bit = cljs.core.nth.call(null,vec__12318,(0),null);
var protocol = cljs.core.nth.call(null,vec__12318,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12321){
var vec__12322 = p__12321;
var ns = cljs.core.nth.call(null,vec__12322,(0),null);
var name = cljs.core.nth.call(null,vec__12322,(1),null);
var selector = cljs.core.nth.call(null,vec__12322,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__12327,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__12327,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__12327,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__12325_SHARP_){
return (obj[cljs.core.first.call(null,p1__12325_SHARP_)]);
});})(name,sorted_matches,vec__12327,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);

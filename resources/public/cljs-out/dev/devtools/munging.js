...
var temp__5455__auto____$1 = (o12228["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o12229 = temp__5455__auto____$1;
return (o12229["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12048__auto__ = f;
return (o__12048__auto__["toString"]).call(o__12048__auto__);
} else {
return "";
}
}catch (e12230){var _ = e12230;
return "";
}});
...
try{var o__12048__auto___12232 = t;
(o__12048__auto___12232["cljs$lang$ctorPrWriter"]).call(o__12048__auto___12232,t,writer);
}catch (e12231){var __12233 = e12231;
}
...
var char_code = (function (){var o__12048__auto__ = (new String(char$));
return (o__12048__auto__["charCodeAt"]).call(o__12048__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12048__auto__ = String;
return (o__12048__auto__["fromCharCode"]).call(o__12048__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12234 = num_code;
switch (G__12234) {
case (1):
return (185);
...
var o__12048__auto__ = String;
return (o__12048__auto__["fromCharCode"]).call(o__12048__auto__,superscript_code);
});
/**
...
}catch (e12236){var _e__12055__auto__ = e12236;
return false;
}})())){
...
var vec__12237 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__12237,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o12240 = temp__5455__auto__;
var temp__5455__auto____$1 = (o12240["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o12241 = temp__5455__auto____$1;
return (o12241["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12244){
var vec__12245 = p__12244;
var ns_detector = cljs.core.nth.call(null,vec__12245,(0),null);
...
var G__12251 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__12252 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__12251;
remaining_tokens = G__12252;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12242){
...
var vec__12256 = cljs.core.split_with.call(null,(function (p1__12255_SHARP_){
return cljs.core.not_EQ_.call(null,p1__12255_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__12256,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__12256,(1),null);
...
var vec__12259 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__12259,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__12259,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__12262 = cljs.core.rest.call(null,remaining_tokens);
var G__12263 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__12262;
name_tokens = G__12263;
continue;
} else {
...
var vec__12266 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__12266,(0),null);
var arity = cljs.core.nth.call(null,vec__12266,(1),null);
var vec__12269 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__12269,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__12269,(1),null);
var vec__12272 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__12272,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__12272,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__12272,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__12272,(3),null);
...
var vec__12278 = result;
var munged_ns = cljs.core.nth.call(null,vec__12278,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__12278,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__12278,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__12278,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__12278,(4),null);
var arity = cljs.core.nth.call(null,vec__12278,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__12282 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__12282,(0),null);
var args = cljs.core.nth.call(null,vec__12282,(1),null);
var vec__12285 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__12285,(0),null);
var name = cljs.core.nth.call(null,vec__12285,(1),null);
...
var G__12288 = (arity + (1));
var G__12289 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12290){
var vec__12291 = p__12290;
var arity = cljs.core.nth.call(null,vec__12291,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__12291,(1),null);
...
return cljs.core.get.call(null,arities,p1__12294_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__12295_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12298){
var vec__12299 = p__12298;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__12299,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12296){
var G__12297 = cljs.core.first.call(null,seq12296);
var seq12296__$1 = cljs.core.next.call(null,seq12296);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12297,seq12296__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__12307__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__12307__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__12307__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__12307__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12308 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__12308,(0),null);
var fn_name = cljs.core.nth.call(null,vec__12308,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__12308,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__12308,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__12308,(4),null);
var arity = cljs.core.nth.call(null,vec__12308,(5),null);
...
var o__12048__auto__ = f;
return (o__12048__auto__["getBasis"]).call(o__12048__auto__);
});
/**
...
}catch (e12312){var _e__12055__auto__ = e12312;
...
var G__12313 = (obj[cljs.core.first.call(null,path)]);
var G__12314 = cljs.core.rest.call(null,path);
obj = G__12313;
path = G__12314;
continue;
} else {
...
return (function (accum,p__12315){
var vec__12316 = p__12315;
var bit = cljs.core.nth.call(null,vec__12316,(0),null);
var protocol = cljs.core.nth.call(null,vec__12316,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12319){
var vec__12320 = p__12319;
var ns = cljs.core.nth.call(null,vec__12320,(0),null);
var name = cljs.core.nth.call(null,vec__12320,(1),null);
var selector = cljs.core.nth.call(null,vec__12320,(2),null);
...
return (function (p__12324){
var vec__12325 = p__12324;
var munged_name = cljs.core.nth.call(null,vec__12325,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__12325,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__12325,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__12323_SHARP_){
return (obj[cljs.core.first.call(null,p1__12323_SHARP_)]);
});})(name,sorted_matches,vec__12325,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);

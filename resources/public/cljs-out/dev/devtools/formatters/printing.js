...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12844){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12845,G__12846,seq12844__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12850_SHARP_){
return !((cljs.core.meta.call(null,p1__12850_SHARP_) == null));
})))){
...
var map__12851 = opts;
var map__12851__$1 = ((((!((map__12851 == null)))?(((((map__12851.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12851.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12851):map__12851);
var markup_db = cljs.core.get.call(null,map__12851__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12855){var _e__12057__auto__ = e12855;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e12857){var _e__12057__auto__ = e12857;
return false;
}}
})())){
...
var _STAR_current_state_STAR_12859 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__12860 = opts;
...
var markup_db = cljs.core.get.call(null,map__12860__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_12859;
}});
...
;
var temp__5455__auto___12864 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___12864)){
var managed_print_level_12865 = temp__5455__auto___12864;
var _STAR_print_level_STAR_12863_12866 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_12865;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_12863_12866,managed_print_level_12865,temp__5455__auto___12864,writer,opts,job_fn){
return (function (p1__12862_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__12862_SHARP_,null);
});})(_STAR_print_level_STAR_12863_12866,managed_print_level_12865,temp__5455__auto___12864,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_12863_12866;
}} else {
job_fn.call(null);
}
